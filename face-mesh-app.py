...
if app_mode =='About App':
    ...
    st.markdown('''
          # About Me \n 
            Hey this is ** Hashim Ali Zaidi **. \n
           
            If you are interested in building more Computer Vision apps like this one then visit the **10 Days of stresmlit** repository on
            Github \n
            
            Also check me out on Social Media
            - [GitHub](https://github.com/hashimali179)
            - [LinkedIn](https://linkedin.com/in/hashimali179)
            - [Facebook](https://facebook.com/hashimali179)
            - [Twitter](https://twitter.com/hashimali179)
            - [Instagram](https://instagram.com/hashimali179)
